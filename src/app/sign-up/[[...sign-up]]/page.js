...
import { ShoppingCart, Users, Truck, Star, Eye, EyeOff, Mail, Lock, User, Phone } from "lucide-react";
      ...
      if (err.errors && Array.isArray(err.errors) && err.errors.length > 0) {
        ...
        switch (err.status) {
          ...
          case 500:
            ...
            break;
          default:
            errorMessage = `Error ${err.status}: ${err.message || 'Something went wrong'}`;
        }
      } else if (err.code) {
        // Error with code
        switch (err.code) {
        ...
        <div className="space-y-8 animate-fade-in-up">
          <div className="space-y-4">
            ...
            <p className="text-lg text-gray-600 leading-relaxed">
              Start your journey with India's trusted platform connecting street
              food vendors with fresh vegetable suppliers. Quality, reliability,
              and growth await.
            </p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-4 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-orange-100">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Quality produce at your doorstep
                </p>
              </div>
            </div>
            <div className="flex items-center space-x-4 p-4 bg-white/60 backdrop-blur-sm rounded-xl border border-green-100">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  Trusted and reliable connections
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="w-full max-w-md">
            <div className="bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-8 border border-white/20">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-600 mt-2">Join the EaseSupply community</p>
              </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full pl-10 pr-4 py-3 text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-300"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full pl-10 pr-12 text-black py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-300"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        className="w-full pl-10 pr-12 py-3 text-black border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent transition-all duration-300"
              ...
              {step === 1 && (
                <>
                  ...
                  <div className="space-y-3">
                    <button className="w-full flex items-center justify-center space-x-3 bg-white border border-gray-300 hover:border-green-500 hover:bg-green-50 text-gray-700 font-medium py-3 px-4 rounded-lg transition-all duration-300">
